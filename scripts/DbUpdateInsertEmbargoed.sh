...
java -classpath $BIN_DIR:$BIN_DIR/jdbcDrivers/mysql-connector-java-8.0.13.jar DbUpdateInsert scripts/DbUpdateInsertEmbargoed.cfg scripts/DbUpdateInsertEmbargoed_env.con
