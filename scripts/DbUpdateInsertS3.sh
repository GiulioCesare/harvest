...
java -classpath $BIN_DIR:$BIN_DIR/jdbcDrivers/mysql-connector-java-8.0.13.jar DbUpdateInsert scripts/DbUpdateInsertS3.cfg scripts/DbUpdateInsertS3_env.con
