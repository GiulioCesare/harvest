...
ETD_CSV="./etd.csv"
ETD_CLEAN="etd_clean.csv"
ETD_LAST_HARVEST_DATE="etd_last_harvest_date.csv"
ETD_NEW_HARVEST_DATE_LIST="etd_new_harvest_date.csv"
...
E_JOURNALS_CSV="./e_journals.csv.srt"
E_JOURNALS_CLEAN="e_journals_clean.csv.srt"

E_JOURNALS_LAST_HARVEST_DATE="e_journals_last_harvest_date.csv"
E_JOURNALS_NEW_HARVEST_DATE_LIST="e_journals_new_harvest_date.csv"
...
# Include scripts
source log_utils.sh
source warc_utils.sh
source receipt_utils.sh
source unimarc_utils.sh
source archived_thesis.sh
source embargo_utils.sh
...
#---------------------------------
# Troviamo rights univoci per sito
#---------------------------------
#find_rights
